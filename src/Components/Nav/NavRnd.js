...
const NavRnd=()=>{
    return(
        <div className="w-full font-mono   flex flex-row border-b-2 border-yellow-500">
            ...
            <div className="w-3/5 bg-white">
                <div className="px-4 py-2">
                    <div class="md:ml-auto flex flex-wrap items-center justify-between">
                ...
                <div className="w-full h-12  rounded-md   bg-yellow-500  ">
